    ...
    <header className="bg-[linear-gradient(-180deg,#f53d2d,#F63)] pb-5 pt-2">
      <div className="container">
        ...
        <div className="mt-4 flex items-end gap-4">
          {/* Logo */}
          <Link to={PATH.home} className="mr-4 hidden px-1 sm:block">
          ...
          {/* End Logo */}
          {/* Search Form */}
          <form className="max-w-[840px] flex-1" onSubmit={onSubmitSearch}>
            <div className="flex rounded-sm bg-white p-1">
              ...
              />
              <button className="hidden rounded-sm bg-primary px-5 text-white transition-all hover:opacity-90 sm:block">
                <svg
