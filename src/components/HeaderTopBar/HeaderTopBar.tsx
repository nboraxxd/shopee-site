...
export default function TopBarHeader() {
  ...
  return (
    <ul className="-mx-2 flex items-center justify-end sm:px-5">
      {/* Language Popover */}
      <Popover
        renderPopover={
      ...
      >
        ...
        <span className="mx-1 text-xs sm:text-sm">Tiếng Việt</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
      ...
      {isAuthenticated && (
        ...
        >
          ...
          <span className="ml-2 line-clamp-1 min-w-[40px] max-w-[155px] break-all text-xs sm:text-sm">
            {user?.email}
          </span>
        </Popover>
      )}
